...
int main() {
    ...
    printf ("Você ira cadastrar as informaçõee: Estado, Código da Carta, Cidade, \nPopulação, Área, PIB e a Quantidade de Pontos Turísticos.\n\n");
    ...
    printf ("igite o código(A letra do estado mais dois números ex:A01): \n");
    scanf ("%s", codido_c1);
